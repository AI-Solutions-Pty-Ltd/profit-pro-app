...
def _build_section_items():
    ...
    sections["Section 1 - Preliminaries"] = [
        (
            "Bill No. 1 - Preliminaries: Fixed Charges",
            "PRE-",
            [
        ...
        (
            ...
            [
                ...
                (
                    "Water and electricity charges (12 months)",
                    "month",
                    12,
                    None,
                    None,
    ...
    sections["Section 6 - Demolition"] = [
        (
            "Bill No. 1 - Earthworks: Demolition",
            "EAR-",
            [
                ("Demolish brick/block walls", "m3", 650, None, "Demolition", 0.15),
                (
                    "Demolish concrete floor slabs 150mm thick",
                    "m3",
                    180,
                    None,
                    "Demolition",
                ...
                (
                    "Demolish and remove roof structures",
                    "m2",
                    520,
                    None,
                    "Demolition",
                ...
                (
                    "Remove existing electrical and plumbing services",
                    "sum",
                    1,
                    None,
                    None,
                ...
                (
                    "Level and compact site after demolition",
                    "m2",
                    1200,
                    None,
                    "Site Preparation",
...
def _new_build_bills(
    ...
    bills.append(
        (
            ...
            [
                (
                    "Remove topsoil average 150mm deep, stockpile",
                    "m2",
                    round(floor_area * 1.3),
                    None,
                    "Site Preparation",
                    0.15,
                ),
                (
                    "Excavate for strip footings in soft material",
                    "m3",
                    round(wall_perim * 0.6 * 0.8),
                    None,
                    "Trench Excavation",
                    0.15,
                ),
                (
                    "Extra-over for intermediate excavation",
                    "m3",
                    round(wall_perim * 0.1),
                    None,
                    "Trench Excavation",
                    0.15,
                ),
                (
                    "Backfill with selected material, compact to 93% Mod AASHTO",
                    "m3",
                    round(wall_perim * 0.3),
                    None,
                    "Backfill & Compact",
                    0.15,
                ),
                (
                    "Dispose surplus excavated material off site",
                    "m3",
                    round(wall_perim * 0.25),
                    None,
                    None,
                    0,
                ),
    ...
    bills.append(
        (
            ...
            [
                (
                    "Blinding 10MPa under footings 50mm thick",
                    "m3",
                    round(wall_perim * 0.6 * 0.05, 1),
                    "15MPa",
                    "Blinding Layer",
                    0.15,
                ),
                (
                    "Strip footings in 20MPa concrete",
                    "m3",
                    footing_vol,
                    "25MPa",
                    "Concrete Placement",
                ...
                (
                    "Surface bed 100mm thick in 25MPa concrete",
                    "m3",
                    slab_vol,
                    "25MPa",
                    "Concrete Placement",
                ...
                (
                    "Reinforced lintels in 25MPa concrete",
                    "m3",
                    round(
                        num_doors * 0.08 + (num_windows_csm + num_windows_sld) * 0.06, 1
                    ),
                    "25MPa",
                    "Concrete Placement",
                    0.15,
                ...
                (
                    "Mesh Ref 395 in surface bed",
                    "m2",
                    round(floor_area * 1.05),
                    "Mesh Reinforcement - Ref 395",
                    "Mesh Laying",
                    0.15,
                ),
                (
                    "Rebar Y12 to footings and lintels",
                    "t",
                    round(footing_vol * 0.08, 2),
                    "Rebar - High Tensile Y12",
                    "Rebar Fixing",
                    0.15,
                ),
                (
                    "Rough formwork to sides of footings",
                    "m2",
                    round(wall_perim * 0.6 * 2, 1),
                    "Rough Formwork - 18mm",
                    "Formwork Erection",
                    0.15,
                ),
                ...
                (
                    "10mm Expansion joints in surface bed",
                    "m",
                    round(floor_area**0.5 * 4),
                    None,
                    None,
                    0,
                ),
    ...
    bills.append(
        (
            ...
            [
                (
                    "Half brick walls in NFP bricks Class II mortar",
                    "m2",
                    half_brick_area,
                    "Half Brick Wall - Class II",
                ...
                (
                    "One brick walls in NFP bricks Class II mortar",
                    "m2",
                    one_brick_area,
                    "One Brick Wall - Class II",
                    "Brickwork - One Brick",
                ...
                (
                    "Face brick external walls, recessed pointing",
                    "m2",
                    face_brick_area,
                    "Face Brick Wall",
                    "Brickwork - Half Brick",
                ...
                (
                    "Precast concrete lintels 110x75mm",
                    "m",
                    round((num_doors + num_windows_csm + num_windows_sld) * 1.2),
                    "Precast Lintels",
                    "DPC Installation",
                    0.15,
                ),
                (
                    "DPC 150mm wide in walls",
                    "m",
                    round(wall_perim * 1.1),
                    "DPC in Walls",
                    "DPC Installation",
                    0.15,
                ),
                (
                    "DPM 375 micron under surface bed",
                    "m2",
                    round(floor_area * 1.05),
                    "DPM Under Slabs",
                    "DPC Installation",
    ...
    bills.append(
        (
            ...
            [
                (
                    "Torch-on waterproofing to wet areas (toilets, kitchenette)",
                    "m2",
                    round(floor_area * 0.15),
                    "Waterproofing Membrane",
                    "Waterproofing Membrane",
                    0.15,
                ),
                (
                    "DPM 250 micron under screed in wet areas",
                    "m2",
                    round(floor_area * 0.15),
                    "DPM 250 Micron",
                    "Waterproofing Membrane",
    ...
    bills.append(
        (
            "Bill No. 5 - Roof Coverings",
            "ROF-",
            [
                (
                    "IBR 0.5mm Chromadek roof sheeting",
                    "m2",
                    roof_area,
                    "IBR Roof Sheeting",
                    "Roof Sheeting",
                ...
                (
                    "Insulation 135mm Isotherm/Aerolite",
                    "m2",
                    round(roof_area * 0.85),
                    "Roof Insulation 135mm",
                    "Roof Insulation",
                    0.15,
                ),
                (
                    "Aluminium flashing to parapets and abutments",
                    "m",
                    round(wall_perim * 0.3),
                    None,
                    None,
    ...
    bills.append(
        (
            "Bill No. 6 - Carpentry and Joinery",
            "CRJ-",
            [
                (
                    "Timber roof trusses, SA Pine, treated",
                    "each",
                    num_trusses,
                    "Timber Roof Truss",
                    "Truss Erection",
                ...
                (
                    "Battens 38x38mm SA Pine at 450mm centres",
                    "m",
                    round(roof_area * 2.2),
                    "Timber Battens 38x38",
                    "Timber Battens",
                ...
                (
                    "Fibre cement fascia board 225x6mm",
                    "m",
                    round(wall_perim * 0.8),
                    "Fibre Cement Fascia",
                    "Timber Battens",
                    0.15,
                ),
                (
                    "Meranti door frames 813x2032mm",
                    "each",
                    num_doors,
                    "Door Frame - Meranti",
                    "Door Hanging",
                ...
                (
                    "Hollow core doors 813x2032x40mm",
                    "each",
                    num_doors,
                    "Hollow Core Door",
                    "Door Hanging",
    ...
    bills.append(
        (
            ...
            [
                (
                    "9.5mm Gypsum ceiling board on 38x38 brandering",
                    "m2",
                    floor_area,
                    "Gypsum Ceiling 9.5mm",
                    "Ceiling Boarding",
                ...
                (
                    "75mm Gypsum coved cornice",
                    "m",
                    round(wall_perim * 1.5),
                    None,
                    "Ceiling Boarding",
                    0.15,
                ),
    ...
    bills.append(
        (
            "Bill No. 8 - Floor Coverings",
            "FLR-",
            [
                (
                    "Ceramic floor tiles 300x300mm on adhesive bed",
                    "m2",
                    round(floor_area * 0.3),
                    "Ceramic Floor Tiles 300x300",
                    "Floor Tiling",
                    0.15,
                ),
                (
                    "Vinyl sheet flooring 2mm thick",
                    "m2",
                    round(floor_area * 0.6),
                    "Vinyl Sheet Flooring",
                    "Floor Tiling",
                    0.15,
                ),
    ...
    bills.append(
        (
            ...
            [
                ...
                (
                    "Hydraulic door closers to external doors",
                    "each",
                    max(2, num_doors // 3),
                    "Door Closer",
                    "Ironmongery Fitting",
    ...
    bills.append(
        (
            "Bill No. 10 - Structural Steelwork",
            "STW-",
            [
                (
                    "Structural steel roof members, hot-dip galvanised",
                    "kg",
                    steel_kg,
                    "Structural Steel IPE",
                    "Steel Erection",
    ...
    bills.append(
        (
            ...
            [
                (
                    "Pressed steel door frames 1.2mm rebated",
                    "each",
                    max(2, num_doors // 3),
                    "Pressed Steel Door Frame",
                    "Steel Frame Install",
                ...
                (
                    "Steel window frames galvanised",
                    "each",
                    max(2, num_windows_csm // 3),
                    "Steel Window Frame",
                    "Steel Frame Install",
                    0.15,
                ),
    ...
    bills.append(
        (
            ...
            [
                (
                    "12mm Cement plaster on internal brick walls",
                    "m2",
                    round(net_wall * 0.7),
                    "Plaster Internal 12mm",
                    "Internal Plastering",
                ...
                (
                    "15mm Cement plaster on external brick walls",
                    "m2",
                    round(ext_wall_area * 0.75),
                    "Plaster External 15mm",
                    "External Plastering",
                    0.15,
                ),
                (
                    "40mm Cement screed to floors",
                    "m2",
                    floor_area,
                    "Screed 40mm",
                    "Screeding",
    ...
    bills.append(
        (
            ...
            [
                (
                    "50mm PVC waste pipes including fittings",
                    "m",
                    plumb_length,
                    "PVC Waste Pipe 50mm",
                    "Pipe Installation",
                ...
                (
                    ...
                    "m",
                    round(wall_perim * 0.5),
                    "PVC Gutter & Downpipe",
                    "Pipe Installation",
                    0.15,
                ),
                (
                    "Pedestal wash basins complete",
                    "each",
                    num_basins,
                    None,
                    "Sanitary Fittings",
                ...
                (
                    "Close-coupled WC suites complete",
                    "each",
                    num_wcs,
                    None,
                    "Sanitary Fittings",
    ...
    bills.append(
        (
            ...
            [
                (
                    "Aluminium casement windows 1200x1200mm",
                    "each",
                    num_windows_csm,
                    "Aluminium Casement Window",
                    "Glass Installation",
                ...
                (
                    "Aluminium sliding windows 1800x1200mm",
                    "each",
                    num_windows_sld,
                    "Aluminium Sliding Window",
                    "Glass Installation",
    ...
    bills.append(
        (
            "Bill No. 15 - Paintwork",
            "PAW-",
            [
                (
                    "PVA interior paint, 2 coats on plastered walls and ceilings",
                    "m2",
                    round(net_wall * 0.7 + floor_area),
                    "PVA Internal 2 Coats",
                    "Internal Painting",
                    0.15,
                ),
                (
                    "Acrylic exterior paint, 2 coats on plastered walls",
                    "m2",
                    round(ext_wall_area * 0.75),
                    "Acrylic External 2 Coats",
                    "External Painting",
                ...
                (
                    "Enamel paint on metalwork, doors and frames",
                    "m2",
                    round(num_doors * 4.5),
                    "Enamel on Metalwork",
                    "Enamel Painting",
    ...
    bills.append(
        (
            "Bill No. 16 - Electrical Installations",
            "ELW-",
            [
                (
                    "20mm PVC conduit in walls and ceilings",
                    "m",
                    conduit_m,
                    "PVC Conduit 20mm",
                ...
                (
                    "LED light fittings 2x18W 1200mm",
                    "each",
                    num_lights,
                    "LED Light Fitting",
                ...
                (
                    "Single-lever light switches",
                    "each",
                    round(num_lights * 0.5),
                    None,
                    None,
                    0,
                ),
                (
                    "12-way distribution board, pre-wired",
                    "each",
                    max(1, round(floor_area / 200)),
                    "Distribution Board",
...
def _conversion_bills(floor_area, wall_perim, wall_height, num_doors, num_windows_csm):
    ...
    bills.append(
        (
            "Bill No. 1 - Concrete, Formwork & Reinforcement",
            "CFR-",
            [
                (
                    "Break out existing floor slab 150mm thick",
                    "m3",
                    round(floor_area * 0.15, 1),
                    None,
                    None,
                    0,
                ),
                (
                    "New 25MPa surface bed 150mm thick",
                    "m3",
                    round(floor_area * 0.15, 1),
                    "25MPa",
                    "Concrete Placement",
    ...
    bills.append(
        (
            ...
            [
                (
                    "Half brick partition walls, NFP Class II",
                    "m2",
                    round(net_wall * 0.3),
                    "Half Brick Wall - Class II",
                    "Brickwork - Half Brick",
                ...
                (
                    ...
                    "m",
                    round((num_doors + num_windows_csm) * 1.2),
                    "Precast Lintels",
                    "DPC Installation",
                    0.15,
                ),
    ...
    bills.append(
        (
            "Bill No. 3 - Waterproofing",
            "WPR-",
            [
                (
                    "Torch-on waterproofing to kitchen floor",
                    "m2",
                    floor_area,
                    "Waterproofing Membrane",
                    "Waterproofing Membrane",
    ...
    bills.append(
        (
            "Bill No. 4 - Carpentry and Joinery",
            "CRJ-",
            [
                (
                    "Meranti door frames",
                ...
                (
                    "Solid timber doors (kitchen rated)",
                    "each",
                    num_doors,
                    "Hollow Core Door",
                    "Door Hanging",
    ...
    bills.append(
        (
            ...
            [
                (
                    "9.5mm Gypsum ceiling board on brandering",
                    "m2",
                    floor_area,
                    "Gypsum Ceiling 9.5mm",
                    "Ceiling Boarding",
    ...
    bills.append(
        (
            "Bill No. 6 - Plastering",
            "PLA-",
            [
                (
                    "12mm Cement plaster on internal walls",
                    "m2",
                    round(net_wall * 0.8),
                    "Plaster Internal 12mm",
                    "Internal Plastering",
    ...
    bills.append(
        (
            "Bill No. 7 - Plumbing and Drainage",
            "PLD-",
            [
                (
                    "110mm PVC soil pipe",
                ...
                (
                    "Commercial stainless steel sink units",
                    "each",
                    3,
                    None,
                    "Sanitary Fittings",
    ...
    bills.append(
        (
            "Bill No. 8 - Electrical Installations",
            "ELW-",
            [
                (
                    "20mm PVC conduit",
                ...
                (
                    "4.0mm cable for heavy-duty circuits",
                    "m",
                    round(floor_area * 1.5),
                    "Cable 2.5mm T&E",
                    "Cable Pulling",
                    0.15,
                ),
    ...
    bills.append(
        (
            ...
            [
                (
                    "PVA interior paint 2 coats on walls and ceilings",
                    "m2",
                    round(net_wall * 0.8 + floor_area),
                    "PVA Internal 2 Coats",
                    "Internal Painting",
                    0.15,
                ),
                (
                    "Enamel paint on doors and frames",
                    "m2",
                    round(num_doors * 4.5),
                    "Enamel on Metalwork",
                    "Enamel Painting",
...
def _refurb_bills(floor_area, wall_perim, wall_height, num_doors):
    ...
    bills.append(
        (
            ...
            [
                (
                    "Remove damaged ceiling boards and brandering",
                    "m2",
                    round(floor_area * 0.3),
                    None,
                    None,
                ...
                (
                    "New 9.5mm Gypsum ceiling board on brandering",
                    "m2",
                    round(floor_area * 0.4),
                    "Gypsum Ceiling 9.5mm",
                    "Ceiling Boarding",
                    0.15,
                ),
    ...
    bills.append(
        (
            "Bill No. 2 - Plastering",
            "PLA-",
            [
                (
                    "Hack off damaged plaster and prepare surfaces",
                    "m2",
                    round(net_wall * 0.25),
                    None,
                    None,
                ...
                (
                    "12mm Re-plaster on internal walls",
                    "m2",
                    round(net_wall * 0.3),
                    "Plaster Internal 12mm",
                    "Internal Plastering",
                ...
                (
                    "40mm Cement screed repairs to floors",
                    "m2",
                    round(floor_area * 0.4),
                    "Screed 40mm",
                    "Screeding",
    ...
    bills.append(
        (
            ...
            [
                (
                    "Replace existing light fittings with LED",
                    "each",
                    round(floor_area / 10),
                    "LED Light Fitting",
                    "Light Fitting Install",
                ...
                (
                    "New PVC conduit runs",
                    "m",
                    round(floor_area * 0.5),
                    "PVC Conduit 20mm",
                    "Conduit Installation",
                    0.15,
                ),
    ...
    bills.append(
        (
            "Bill No. 5 - Plumbing and Drainage",
            "PLD-",
            [
                ("Replace mixer taps", "each", 8, None, "Sanitary Fittings", 0.15),
                (
                    "Repair/replace waste pipes",
                    "m",
                    20,
                    "PVC Waste Pipe 50mm",
                    "Pipe Installation",
    ...
    bills.append(
        (
            "Bill No. 6 - Ironmongery",
            "IRM-",
            [
                (
                    "New 3-lever mortice locks",
                    "each",
                    num_doors,
                    "3-Lever Mortice Lock",
                    "Ironmongery Fitting",
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for section, bills in sections_data.items():
            ...
            for bill_name, trade_prefix, items in bills:
                ...
                header_fields = {
                    ...
                    "item_no": "",
                    "pay_ref": "",
                    "description": bill_name.split(" - ", 1)[-1]
                    if " - " in bill_name
                    else bill_name,
                    "unit": "",
                ...
                BOQItem.objects.create(
                    **header_fields, progress_quantity=None, forecast_quantity=None
                )
                baseline_count += 1
                output_count += 1
                ...
                for desc, unit, qty, spec_name, labour_name, markup_pct in items:
                    ...
                    labour = (
                        labour_map.get((section, labour_name)) if labour_name else None
                    )
        ...
        self.stdout.write(
            f"  {baseline_count} baseline items, {output_count} output items"
        )
        ...
        self.stdout.write(
            f"  Spec Components: {SpecificationComponent.objects.count()}"
        )
        ...
        for section in SECTION_PROGRESS:
            items = BOQItem.objects.filter(section=section, is_section_header=False)
            sec_total = sum((i.contract_amount or 0) for i in items)
        ...
        for sname in [
            ...
            if spec:
                self.stdout.write(
                    f"  {sname}: material R{spec.rate_per_unit:.2f}/{spec.unit_label}"
                )
