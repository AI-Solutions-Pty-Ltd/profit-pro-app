...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        mat_spec_rules = [
            ...
            (
                ["brick reinforcement", "75mm wide brick", "brickforce"],
                "m",
                "Damp Course - DPC 75mm",
            ),
            ...
            # Formwork
            (
                ["formwork", "shuttering", "shutterboard"],
                "m2",
                "Rough Formwork Shutterboard - 18mm",
            ),
            ...
            (
                ["various bars", "rebar", "high-tensile"],
                "t",
                "Rebar Reinforcement - High Tensile Y12",
            ),
            # DPC / DPM
            (
                ["under surface bed", "under apron", "damp proof membrane", "dpm"],
                "m2",
                "Damp Proof Membrane - DPM 250Micron",
            ),
        ...
        direct_mat_rules = [
            ...
            # Windows
            (
                ["aluminium window", "aluminum window", "casement window"],
                "No",
                "ALU-WIN-CSM",
            ),
            ...
            (
                ["vinyl", "vinyl floor", "wax polish", "vinyl tile"],
                "m2",
                "CEL-TILE-VIN",
            ),
            # Plumbing / drainage
            ...
            (
                ["test terminal", "terminal block", "cadweld", "connection"],
                "No",
                "DB-BRK-20A",
            ),
            ...
            (
                ["supply and install", "supply and delivery", "allow"],
                "Item",
                "SAN-TAP-MIX",
            ),
            # Overhaul
            ...
            (
                ["telephone point", "data point", "surface mounted", "appliance"],
                "No",
                "FIT-SOC-DBL",
            ),
            # Earthworks
        ...
        lab_rules = [
            ...
            (
                ...
                "m2",
                "Excavations - Site Preparation",
            ),
            (
                ["excavat", "excavate for restricted", "trench"],
                "m3",
                "Excavations - Manual Trenches",
            ),
            (
                ["intermediate excavat", "intermediate rock", "intermediate"],
                "m3",
                "Excavations - Manual Intermediate Rock",
            ),
            (
                ["hard rock excavat", "hard rock"],
                "m3",
                "Excavations - Manual Hard Rock",
            ),
            # Concrete placement
            (
                [
            ...
            # Formwork
            (
                ["to sides footing", "sides footing", "side of footing"],
                "m2",
                "Formwork - Sides",
            ),
            (
                ["formwork", "shutterboard", "shuttering"],
                "m2",
            ...
            (
                ["various bars", "rebar", "high-tensile", "reinforcement bar"],
                "t",
                "Rebar Reinforcement",
            ),
            # Soil
            ...
            (
                ["tiling", "tile", "ceramic", "porcelain", "vinyl"],
                "m2",
                "Concrete Finishes",
            ),
            (
            ...
            (
                ["roofing", "roof sheet", "ibr", "corrugated", "roof covering"],
                "m2",
                "Formwork - Soffits",
            ),
            ...
            # General m labour
            (
                ["gutter", "downpipe", "fascia", "barge board", "cornice", "skirting"],
                "m",
                "Concrete Edges",
            ),
            (
                ["pipe", "conduit", "cable", "conductor", "core", "dia"],
                "m",
                "Concrete Edges",
            ),
            ...
            (
                ["earth wire", "earth bar", "copper", "bare stranded", "warning tape"],
                "m",
                "Concrete Edges",
            ),
            ...
            # Item unit
            (
                ["sign", "label", "db coc", "allow", "supply", "install", "danger"],
                "Item",
                "Concrete Sundries",
            ),
            # m3.km
            ...
            (
                ["narrow width", "on narrow", "pane", "exceeding"],
                "m2",
                "Concrete Finishes",
            ),
        ...
        for item in output_items:
            ...
            if not item.specification and not item.material:
                m = find_direct_material(
                    item.description, item.unit, direct_mat_rules, all_materials
                )
                if m:
                    item.material = m
                    direct_mat += 1
            ...
            if not item.labour_specification:
                matched_labour = match_rules(
                    item.description, item.unit, lab_rules, labour_specs
                )
                if matched_labour:
        ...
        # Coverage stats
        with_any = (
            BOQItem.objects.filter(is_section_header=False)
            .exclude(
        ...
        self.stdout.write(
            f"    Coverage: {with_any}/{total} ({100 * with_any // total}%)"
        )
