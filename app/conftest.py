...
# @pytest.fixture(autouse=True)
# def bypass_subscription_check():
#     """Fixture to bypass subscription check for specific tests."""
#     mock = patch.object(Account, "has_subscription_tier", return_value=True)
#     yield mock, mock.start()
#     mock.stop()
