...
from app.BillOfQuantities.exporters.detailed_report_exporter import export_detailed_report_to_xlsx
from app.BillOfQuantities.exporters.summary_report_exporter import export_summary_report_to_xlsx
...
def export_unified_xlsx(payment_certificate, sections, is_abridged=False):
    ...
    if summary:
        export_summary_report_to_xlsx(payment_certificate, is_abridged=is_abridged, wb=wb)
        
    if detailed:
        export_detailed_report_to_xlsx(payment_certificate, is_abridged=is_abridged, wb=wb)
