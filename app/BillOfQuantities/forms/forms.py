...
class BaseLineItemFormSet(forms.models.BaseInlineFormSet):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        ...
        for form in self.forms:
            ...
            form.fields["item_number"].required = False
            form.fields["description"].required = False
            form.fields["unit_measurement"].required = False
            form.fields["budgeted_quantity"].required = False
            form.fields["unit_price"].required = False


LineItemInlineFormSet = forms.models.inlineformset_factory(
    Structure,
    LineItem,
    form=LineItemForm,
