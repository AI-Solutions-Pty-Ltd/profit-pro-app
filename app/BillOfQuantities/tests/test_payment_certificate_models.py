...
class TestPaymentCertificateProperties:
    ...
    def test_current_ledger_totals_with_debits_and_credits(self):
        ...
        assert cert.get_materials_on_site_total() == Decimal("2500.00")
        assert cert.get_escalation_total() == Decimal("1500.00")
        assert cert.get_special_item_total() == Decimal("6000.00")
    ...
    def test_previous_ledger_totals_with_debits_and_credits(self):
        ...
        assert cert2.previous_retention_total == Decimal("4000.00")
