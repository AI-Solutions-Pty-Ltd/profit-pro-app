        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        help_text="Description of the item", max_length=500
                    ),
                ),
                (
                    "submission_due_date",
                    models.DateField(
                        blank=True, help_text="Due date for submission", null=True
                    ),
                ),
                (
                    "submission_date",
                    models.DateField(
                        blank=True, help_text="Actual submission date", null=True
                    ),
                ),
                (
                    "approval_due_date",
                    models.DateField(
                        blank=True, help_text="Due date for approval", null=True
                    ),
                ),
                (
                    "approval_date",
                    models.DateField(
                        blank=True, help_text="Actual approval date", null=True
                    ),
                ),
                (
                    "status",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="Project_adm_project_8c966b_idx",
                    ),
                    models.Index(
                        fields=["project", "status"],
                        name="Project_adm_project_d72dcc_idx",
                    ),
                    models.Index(
                        fields=["submission_due_date"],
                        name="Project_adm_submiss_fc936f_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "due_date",
                    models.DateField(
                        blank=True, help_text="Due date for this obligation", null=True
                    ),
                ),
                (
                    "frequency",
                ...
                (
                    "expiry_date",
                    models.DateField(
                        blank=True, help_text="Expiry date where applicable", null=True
                    ),
                ),
                (
                    "status",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["project", "status"],
                        name="Project_con_project_eecb27_idx",
                    ),
                    models.Index(
                        fields=["responsible_party"],
                        name="Project_con_respons_5ae135_idx",
                    ),
                    models.Index(
                        fields=["due_date"], name="Project_con_due_dat_6ed873_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        help_text="Description of the document", max_length=500
                    ),
                ),
                (
                    "test_date",
                ...
                (
                    "submission_date",
                    models.DateField(
                        blank=True, help_text="Date document was submitted", null=True
                    ),
                ),
                (
                    "approval_date",
                    models.DateField(
                        blank=True, help_text="Date document was approved", null=True
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.FileField(
                        ...
                        null=True,
                        upload_to=app.Project.models.compliance_models.FinalAccountCompliance.upload_to,
                    ),
                ),
                (
                    "notes",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="Project_fin_project_174309_idx",
                    ),
                    models.Index(
                        fields=["project", "status"],
                        name="Project_fin_project_7a7b64_idx",
                    ),
                ],
            },
        ),
