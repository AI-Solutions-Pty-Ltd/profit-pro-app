...
class ProductionPlanFactory(DjangoModelFactory):
    ...
    structure = factory.SubFactory(StructureFactory, project=factory.SelfAttribute('..project'))
    bill = factory.SubFactory(BillFactory, structure=factory.SelfAttribute('..structure'))
