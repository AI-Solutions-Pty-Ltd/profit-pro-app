...
def seed_units():
    units = [
        ...
        {"name": "Kilometer", "short_name": "km", "category": UnitOfMeasure.Category.LENGTH},
        {"name": "Millimeter", "short_name": "mm", "category": UnitOfMeasure.Category.LENGTH},
        
        # Area
        {"name": "Square Meter", "short_name": "m2", "category": UnitOfMeasure.Category.AREA},
        {"name": "Hectare", "short_name": "ha", "category": UnitOfMeasure.Category.AREA},
        
        # Volume
        {"name": "Cubic Meter", "short_name": "m3", "category": UnitOfMeasure.Category.VOLUME},
        {"name": "Liter", "short_name": "L", "category": UnitOfMeasure.Category.VOLUME},
        
        # Weight
        {"name": "Kilogram", "short_name": "kg", "category": UnitOfMeasure.Category.WEIGHT},
        ...
        {"name": "Number", "short_name": "no", "category": UnitOfMeasure.Category.COUNT},
