        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_issued",
                    models.DateField(
                        auto_now_add=True, help_text="Date this RFI was issued"
                    ),
                ),
                (
                    "subject",
                    models.CharField(help_text="Subject of the RFI", max_length=255),
                ),
                (
                    "message",
                    models.TextField(help_text="Detailed description or question"),
                ),
                (
                    "attachment",
                    models.FileField(
                        ...
                        null=True,
                        upload_to=app.SiteManagement.models.rfi.RFI.upload_to,
                    ),
                ),
                (
                    "respond_by_date",
                ...
                (
                    "response",
                    models.TextField(blank=True, help_text="Response to this RFI"),
                ),
                (
                    "response_attachment",
                    models.FileField(
